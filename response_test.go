...
func TestMarshalPayload(t *testing.T) {
	...
	jsonapi.MarshalPayload(out1, book)
	...
	jsonapi.MarshalPayload(out2, books)
...
func TestMarshalPayloadWithNulls(t *testing.T) {
	...
	if err := jsonapi.MarshalPayload(out, books); err != nil {
		t.Fatal(err)
	}
...
func TestMarshal_attrStringSlice(t *testing.T) {
	...
	out := bytes.NewBuffer(nil)
	if err := jsonapi.MarshalPayload(out, b); err != nil {
		t.Fatal(err)
	}
...
func TestWithoutOmitsEmptyAnnotationOnRelation(t *testing.T) {
	...
	out := bytes.NewBuffer(nil)
	if err := jsonapi.MarshalPayload(out, blog); err != nil {
		t.Fatal(err)
	}
...
func TestWithOmitsEmptyAnnotationOnAttribute(t *testing.T) {
	...
	out := bytes.NewBuffer(nil)
	if err := jsonapi.MarshalPayload(out, author); err != nil {
		t.Fatal(err)
	}
...
func TestMarshalIDPtr(t *testing.T) {
	...
	out := bytes.NewBuffer(nil)
	if err := jsonapi.MarshalPayload(out, car); err != nil {
		t.Fatal(err)
	}
...
func TestMarshalOnePayload_omitIDString(t *testing.T) {
	...
	foo := &Foo{Title: "Foo"}
	out := bytes.NewBuffer(nil)
	if err := jsonapi.MarshalPayload(out, foo); err != nil {
		t.Fatal(err)
	}
...
func TestMarshall_invalidIDType(t *testing.T) {
	...
	out := bytes.NewBuffer(nil)
	if err := jsonapi.MarshalPayload(out, o); err != jsonapi.ErrBadJSONAPIID {
		t.Fatalf(
			"Was expecting a `%s` error, got `%s`", jsonapi.ErrBadJSONAPIID, err,
		)
	}
}
...
func TestOmitsEmptyAnnotation(t *testing.T) {
	...
	out := bytes.NewBuffer(nil)
	if err := jsonapi.MarshalPayload(out, book); err != nil {
		t.Fatal(err)
	}
...
func TestHasPrimaryAnnotation(t *testing.T) {
	...
	out := bytes.NewBuffer(nil)
	if err := jsonapi.MarshalPayload(out, testModel); err != nil {
		t.Fatal(err)
	}

	resp := new(jsonapi.OnePayload)
...
func TestSupportsLinkable(t *testing.T) {
	...
	commentsMetaObject := jsonapi.Meta(commentsMetaMap)
...
func TestMarshalPayloadWithoutIncluded(t *testing.T) {
	...
	out := bytes.NewBuffer(nil)
	if err := jsonapi.MarshalPayloadWithoutIncluded(out, data); err != nil {
		t.Fatal(err)
	}
...
func TestMarshalPayload_many(t *testing.T) {
	...
	out := bytes.NewBuffer(nil)
	if err := jsonapi.MarshalPayload(out, data); err != nil {
		t.Fatal(err)
	}

	resp := new(jsonapi.ManyPayload)
	if err := json.NewDecoder(out).Decode(resp); err != nil {
		t.Fatal(err)
	}
...
func TestMarshalMany_SliceOfInterfaceAndSliceOfStructsSameJSON(t *testing.T) {
	...
	if err := jsonapi.MarshalPayload(structsOut, structs); err != nil {
		t.Fatal(err)
	}
	interfacesOut := new(bytes.Buffer)
	if err := jsonapi.MarshalPayload(interfacesOut, interfaces); err != nil {
		t.Fatal(err)
	}
...
func TestMarshal_InvalidIntefaceArgument(t *testing.T) {
	...
	if err := jsonapi.MarshalPayload(out, true); err != jsonapi.ErrUnexpectedType {
		t.Fatal("Was expecting an error")
	}
	if err := jsonapi.MarshalPayload(out, 25); err != jsonapi.ErrUnexpectedType {
		t.Fatal("Was expecting an error")
	}
	if err := jsonapi.MarshalPayload(out, Book{}); err != jsonapi.ErrUnexpectedType {
		t.Fatal("Was expecting an error")
	}
}
...
func TestAddPagination(t *testing.T) {
	...
	expected := &jsonapi.Links{
		"first": "/?page[offset]=0&page[limit]=100",
		"last":  "/?page[offset]=500&page[limit]=100",
		"next":  "/?page[offset]=200&page[limit]=100",
	}
